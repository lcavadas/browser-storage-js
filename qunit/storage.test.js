...
$(document).ready(function () {
  ...
  asyncTest("getNoCollection", function () {
    storage(function (storage) {
      _cleanup(storage, getNoCollection);
    }, 'LocalStorage');
  });
  asyncTest("getAllNoCollection", function () {
    storage(function (storage) {
      _cleanup(storage, getAllNoCollection);
    }, 'LocalStorage');
  });
  asyncTest("removeNoCollection", function () {
    storage(function (storage) {
      _cleanup(storage, removeNoCollection);
    }, 'LocalStorage');
  });
  asyncTest("removeAllNoCollection", function () {
    storage(function (storage) {
      _cleanup(storage, removeAllNoCollection);
    }, 'LocalStorage');
  });
  ...
  var getNoCollection = function (storage) {
    storage.get("thisIsACollectionThatWillNotBePresent", 1, function (value) {
      equal(value, undefined, "has null result");
      storage.close();
      start();
    });
  };

  var getAllNoCollection = function (storage) {
    storage.getAll("thisIsACollectionThatWillNotBePresent", function (values) {
      equal(values.length, 0, "has no results");
      storage.close();
      start();
    });
  ...
  var removeNoCollection = function (storage) {
    storage.remove("thisIsACollectionThatWillNotBePresent", 1, function () {
      expect(0);
      storage.close();
      start();
    });
  ...
  var removeAllNoCollection = function (storage) {
    storage.removeAll("thisIsACollectionThatWillNotBePresent", function () {
      expect(0);
      storage.close();
      start();
    });
